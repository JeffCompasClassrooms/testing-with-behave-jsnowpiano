...
Scenario: Search is blank
    Given I open the url "https://kb.printerlogic.com/s/knowledge-base"
    Then I expect that element "input" is visible
    Then I expect that element "input" is empty

Scenario: Search for printer documentation
    Given I open the url "https://kb.printerlogic.com/s/knowledge-base"
    When I set "printer" to the inputfield "input.search-input"
...
Scenario: Search brings results
    Given I open the url "https://kb.printerlogic.com/s/knowledge-base"
    When I set "push trust" to the inputfield "input.search-input"
    And I press "Enter"
    And I pause for 3000ms
